...
var RootCmd = &cobra.Command{
	Use:   "gohjasmincli",
	Short: "gohjasmincli is the cli helper tool for the gohjasmindd dyndns service",
	Long: `gohjasmincli is the cli helper tool for the gohjasmindd dyndns service

	With this cli you can create, change and update dyndns configuration.`,
